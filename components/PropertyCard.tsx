...
export const PropertyCard: React.FC<PropertyCardProps> = ({ property, featuredDesign = false }) => {
      ...
      <div className="p-4 flex flex-col grow">
        <div className="flex justify-between items-baseline mb-2">
          <h3 className="font-bold text-lg text-nordic-dark">
            ...
            {property.price_per_month && <span className="text-sm font-normal text-nordic-muted">/mo</span>}
          </h3>
        </div>
